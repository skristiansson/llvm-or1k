//===-- OR1KELFWriterInfo.h - ELF Writer Info for OR1K ----------*- C++ -*-===//
//
...
namespace llvm {
  ...
  class OR1KELFWriterInfo : public TargetELFWriterInfo {
  public:
    OR1KELFWriterInfo(TargetMachine &TM);
    virtual ~OR1KELFWriterInfo();
